...
from app.constants import DEFAULT_TENT_COLOR, DEFAULT_TEXT, DEFAULT_FONT_COLOUR, DEFAULT_OUTPUT_DIR
...
async def create_mockups(
    ...
    try:
        ...
        overlay_data = OverlayRequest(slope_color=slope_color, canopy_color=canopy_color, walls_primary_color=walls_primary_color, walls_secondary_color=walls_secondary_color, walls_tertiary_color=walls_tertiary_color, text=text, font_color=font_color, is_patterned=f"{patterned}", output_dir=output_dir)
        
        mockups = apply_all_logos(overlay_data, logo_content)
        return mockups
